...
export interface IRendererTickContext {
	callbacks: IRendererTickCallback[];
	deltaTime: number;
	time: number;
}

export type IRendererTickCallback = (context: IRendererTickContext) => void;
...
export let EngineState: IRendererState;
...
export function initThree(canvas: HTMLCanvasElement) {
	...
	const callbacks: IRendererTickCallback[] = [];
